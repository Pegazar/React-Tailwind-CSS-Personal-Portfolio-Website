        ...
        <div className='bg-[#323946] w-full pt-16 pb-40'>
            <div className='container'>
                ...
                <div className="flex items-center xl:flex-row flex-col-reverse">
                    <div className="flex-1 xl:block flex flex-col xl:flex-row mt-20 xl:mt-0 px-4 xl:px-0">
                        <h1 className="text-white text-2xl font-medium z-1 mb-6">
                            <Link to="/">
                    ...
                    <div className="flex-1">
                        <form className="flex flex-col gap-5">
                            <div className="xl:flex items-center gap-5">
                                <input className="w-full h-[53px] xl:mb-0 mb-5 text-white outline-none border-none bg-[#1F242D] rounded-xl px-5 placeholder:text-white" type="text" placeholder="First Name" />
                            ...
                            <div className="xl:flex items-center gap-5">
                                <input className="w-full h-[53px] xl:mb-0 mb-5 text-white outline-none border-none bg-[#1F242D] rounded-xl px-5 placeholder:text-white" type="tel" placeholder="Phone" />

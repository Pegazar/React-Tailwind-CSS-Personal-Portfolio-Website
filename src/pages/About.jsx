      ...
      <div className='container'>
        <div className='flex items-center xl:flex-row flex-col'>
          ...
          <div className='flex-1'>
            ...
            <p className='mb-5 text-sm text-white'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas iste similique, sequi porro enim accusamus? Libero quod esse dolores sint quia repudiandae dignissimos, id dolore. Nostrum mollitia enim libero nobis quae aliquam rerum cumque impedit.</p>

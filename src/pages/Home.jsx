...
const Home = () => {
  return (
    <div className='relative bg-cover bg-center min-h-screen'
      ...
      <div className='container p-4 flex items-center xl:flex-row flex-col-reverse xl:pt-32 pt-16'>
        <div className='flex-1 z-20 xl:pt-0 pt-4'>
        ...
        <div className='flex-1 z-20 flex items-center justify-center xl:pt-0 pt-2'>
